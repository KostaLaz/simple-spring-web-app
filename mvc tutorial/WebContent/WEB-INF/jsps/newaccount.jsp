...
<tr><td class="label">Userame:</td><td><form:input path="username" name="username" type="text"/><br/><form:errors path="name" cssClass="error"></form:errors></td></tr>
<tr><td class="label">Password:</td><td><form:input path="passord" name="password" type="text"/><br/><form:errors path="name" cssClass="error"></form:errors></td></tr>
